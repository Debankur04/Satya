...
const Page = () => {
  ...
  const uploadToSupabase = async (file, type) => {
    ...
    // ✅ FIX: Correct way to get the public URL
  ...
  const verifyVideo = async videoUrl => {
    try {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <Image size={20} />
              <span>
                {files.image ? files.image.name.slice(0, 15) + "..." : "Upload Image"}
              </span>
            </button>
            ...
            >
              <Video size={20} />
              <span>
                {files.video ? files.video.name.slice(0, 15) + "..." : "Upload Video"}
              </span>
            </button>
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 p-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-blue-400"
          >
            <Send size={20} />
